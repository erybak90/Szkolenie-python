...
def test_add_contact(app):
    ...
    contact = Contact(Firstname="First name", Lastname="Last name", Nickname="NIckname", company="Corpo", homephone="000000000",
                mobilephone="698998657",
                workphone="555588888", secondaryphone="888889999")
