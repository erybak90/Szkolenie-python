...
def test_add_contact(app):
    ...
    app.group.open_add_new_contact_form()
    app.group.init_fill_contact_form(
...
def test_add_empty_contact(app):
    ...
    app.session.login(username="admin", password="secret")
    app.group.open_add_new_contact_form()
    app.group.init_fill_contact_form(Contact(Firstname="", Lastname="", Nickname="", company="", adress="", mobile="",
                                       email="", notes=""))
    app.group.submit_contact_creation()
    app.session.logout()
